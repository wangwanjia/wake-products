<template>
  <div class="container-order-edit p-4 bg-white rounded-lg shadow-md">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">编辑订单</h3>
...
const getOrderData = (id) => {
  // 在实际应用中，这里应该是API调用
  const mockOrders = [
    { id: 1, orderName: '订单1', ip: '192.168.1.1', city: '北京', device: '11231' },
    { id: 2, orderName: '订单2', ip: '192.168.1.2', city: '上海', device: '2131231' },
    { id: 3, orderName: '订单3', ip: '192.168.1.3', city: '广州', device: '1244122' }
  ];
