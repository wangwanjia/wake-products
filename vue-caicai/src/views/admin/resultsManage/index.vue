<template>
  <el-tabs v-model="activeName" class="tabs-index" @tab-click="handleClick">
        ...
        <div class="overflow-x-auto">
          ...
          >
            ...
            <el-table-column prop="codeObjArr" label="开奖结果">
              <template #default="scope">
                <ul class="flex justify-start items-center gap-4 py-3">
...
import GetOpenCode from "../components/GetOpenCode.vue";
// 请求
import {
  getOpenCodeList,
  getOpenCodeByDate,
...
const handleEdit = (index, row) => {
  ...
  router.push({
    path: "/admin/resultsManage/resultsEdit",
    query: filteredRow,
  });
};
...
const addResult = () => {
  router.push({
    path: "/admin/resultsManage/resultsAdd",
  });
};
